...
//	}
	...
	public void createAvailabilityRequestSendImmediat() throws Throwable {
		...
		ar.ARSendImmediate(driver,date, date2, gTimeA7min, dateAft2Days, gTimeA22min,deptName, gCurrntTime,  BranchNameB);
	...
	public void createAvailabilityRequestSendRecursive() throws Throwable {
		...
		ar.availabilityRequestCommon(driver,BranchNameB);
		ar.ARRecursivee(driver,date, today, gTimeA7min, gTimeA22min, dayAf2day, dayAf4day,deptName,gCurrntTime,  BranchNameB);
	...
	public void createAvailabilityRequestSendMultipleDays() throws Throwable {
		...
		ar.availabilityRequestCommon(driver,BranchNameB);
		ar.ARSendMultiple(driver, date, gTimeA7min, gTimeA11min, gTimeA15min, dayAf2day, dayAf4day, gTimeA22min,deptName,gCurrntTime,  BranchNameB);
